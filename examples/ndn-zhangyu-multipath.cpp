...
main (int argc, char *argv[])
{
	...
	//----------------仿真拓扑----------------
	AnnotatedTopologyReader topologyReader ("", 2);
	...
	topologyReader.SetFileName ("src/ndnSIM/examples/topologies/6Nodes-Debug.txt");
	...
	for(uint32_t i=0;i<producerNodes.size();i++)	{
		...
		producerHelper.SetAttribute ("PayloadSize", StringValue("102400"));
